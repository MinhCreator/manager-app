package minhcreator.component.menu.mode;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("minhcreator/assets/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("minhcreator/assets/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("minhcreator/assets/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("minhcreator/assets/mode/light.svg"));
        }
    }

...
import minhcreator.component.Alert.Alert;
...
public class Message extends Alert {
    ...
    public Message(javax.swing.JFrame parent, boolean modal, String Header, String message, String iconic_path, String buttonText) {
        super(parent, modal);
        this.Header = Header;
    ...
    public Message(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponent();
    }
    ...
    private void initComponent() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon(iconic_path);
        ...
        button.addActionListener(e -> closeAlert());
